...
<body>
    ...
    <div class="flex py-1 bg-menu-title border-b border-solid border-gray-300 menu-layout w-full">
        ...
        <div class="relative group">
            <span class="cursor-pointer px-3">Dữ liệu</span>
            <ul class="ul-menu">
        ...
        <div class="relative group">
            <span class="cursor-pointer px-3">Danh mục</span>
            <ul class="ul-menu">
        ...
        <div class="relative group">
            <span class="cursor-pointer px-3">Báo cáo</span>
            <ul class="ul-menu">
...
{{--        <div class="relative group">--}}
{{--            <span class="cursor-pointer px-3">Trợ giúp</span>--}}
{{--            <ul class="ul-menu">--}}
{{--                <li class="li-menu"><a href="" class="a-menu">Hướng dẫn sử dụng</a></li>--}}
{{--                <li class="li-menu"><a href="" class="a-menu">Liên hệ với chúng tôi</a></li>--}}
{{--            </ul>--}}
{{--        </div>--}}
    </div>
    <div class="px-3 py-2 ">
