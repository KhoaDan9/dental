...
<div class="pb-2 flex justify-between border-b-1 border-gray-300 mb-2">
    <div>
        <span>Báo cáo >> <a href="{{ $url_1 }}">{{ $title_1 }}</a></span>
    </div>
        ...
        <div class="flex space-x-1">
            ...
            @if($service_group_id)
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-grow flex-col">
                        <select class='pl-1 border-gray-400 border-[0.5px] rounded outline-none'
                                wire:model.live.debounce='{{ $service_group_id }}'>
                            <option value="">-</option>
            ...
            @if($service_id)
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-grow flex-col">
                        <select class='pl-1 border-gray-400 border-[0.5px] rounded outline-none w-55'
