        ...
        @else
            <div class="print-invoice w-5xl pr-3">
                ...
                <div class="flex flex-col">
                    <p><strong>Họ và tên: </strong>{{ $patient->name }} - <strong>Năm
                            sinh: </strong>{{ $patient->birth }}
                    </p>
                    ...
                    <div class="flex">
                        ...
                        <div class="w-[40%] text-right">
                            ...
                            <div class="w-full">
                                ...
                                <span
                                    class="w-26  inline-block pr-[6px]">{{ convertToString($this->current_paid) }}</span>
                            </div>
                            <div class="w-full">
                                <strong>Còn lại:</strong>
                                <span
                                    class="w-26  inline-block pr-[6px]">{{ convertToString($this->final_debt) }}</span>
                            </div>
                        </div>
                    </div>
                    @if ($prescription)
