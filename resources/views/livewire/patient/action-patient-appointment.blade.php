<div>
    <x-all-heading head_title="Dữ liệu" title_1="Hồ sơ bệnh nhân" url_1="/patients"
                   ...
                   title_3="Lịch hẹn" exit_url="/patients"
        ...
        <form wire:submit='save'>
            <div class="flex">
                <div class="action-display">
                    ...
                    {{--                <x-all-select-input model="form.visit_count" title="Lần khám:" :values="$visit_counts"/>--}}
                    <x-all-text-input title="Thời gian hẹn:" model="form.visit_count" type="datetime-local"/>
